...
@section('content')
      <div class="container-fluid p-0">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="name" placeholder="{{$feedBackDetail->customer_name}}" name="name" value="" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="feedback" placeholder="{{$feedBackDetail->feedback}}" name="feedback" value="" required>
                    </div>
                </div>
