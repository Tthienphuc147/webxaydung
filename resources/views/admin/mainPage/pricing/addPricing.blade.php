      ...
      <div class="container-fluid p-0">
                        <div class="email-head">
                            <div class="email-head-subject">
                                <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-star"></i></span></a> <span>Thêm bảng giá</span>
                                   
                                </div>
                            </div>
                        </div>
                        <form class="form-horizontal"  action="/admin/pricing/add" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                ...
                <p><label>Nội dung</label></p>
                    <textarea name="noidung" id="demo" class="form-control ckeditor" rows="3" required>
