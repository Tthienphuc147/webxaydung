...
@section('content')
   <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">THÊM CHỨNG CHỈ</h5>
                                    <div class="card-body">
                                        <form  action="/admin/slideCertification/add/slide" method="POST" enctype="multipart/form-data">
                                          {{csrf_field()}}
                                            </div>
                                             <div class="form-group">
                                                <label for="image" class="col-form-label">Ảnh chứng chỉ</label>
